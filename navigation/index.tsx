...
import QRVerifierScreen from "../screens/QRVerifierScreen";
  ...
  return (
    <Stack.Navigator>
      ...
      >
        ...
        />
        <Stack.Screen 
          name="QRVerifierScreen"
          component={QRVerifierScreen}
          options={{
            headerTransparent: true,
            headerTintColor: Colors["primaryColor"],
            headerTitle: "Participant Verification",
            animation: "fade_from_bottom",
            animationTypeForReplace: "push",
          }}
        />
  ...
  return (
    ...
    >
      <BottomTab.Screen
        ...
        options={({ navigation }: RootTabScreenProps<"Workshops">) => ({
          title: "Workshops",
          tabBarIcon: ({ color }) => (
